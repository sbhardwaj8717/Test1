...
def TakeImages():
    ...
    if (is_number(Id) and name.isalpha()):
        ...
        face_cascade = cv2.CascadeClassifier('C:/Users/91935/PycharmProjects/untitled/haarcascade_frontalface_alt.xml')
        face_data = []
        cnt = 0
        ...
        while True:
            ...
            for face in faces:
                ...
                cv2.imwrite("C:/Users/91935/PycharmProjects/untitled/TrainingImage/ " + name + "." + Id + '.' + str(len(face_data)) + ".jpg", gray[y:y + h, x:x + w])
                if cnt % 10 == 0:
        ...
        np.save("C:/Users/91935/PycharmProjects/untitled/FaceData/" + user_name + ".npy", face_data)
...
def TrainAndTrackImages():
    ...
    face_cascade = cv2.CascadeClassifier("C:/Users/91935/PycharmProjects/untitled/haarcascade_frontalface_alt.xml")
    cam=cv2.VideoCapture(0)
    dataset_path = "C:/Users/91935/PycharmProjects/untitled/FaceData/"
    labels = []
    class_id = 0
    names = {}
    face_data = []
