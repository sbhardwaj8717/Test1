...
def TakeImages():
    ...
    if (is_number(Id) and name.isalpha()):
        ...
        harcascadePath = "C:/Users/user/PycharmProjects/E-Yantra/haarcascade_frontalface_default.xml"
        ...
        while (True):
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.imwrite("C:/Users/user/PycharmProjects/E-Yantra/TrainingImage/ " + name + "." + Id + '.' + str(sampleNum) + ".jpg", gray[y:y + h, x:x + w])
                # display the frame
...
def TrainImages():
    ...
    harcascadePath = "C:/Users/user/PycharmProjects/E-Yantra/haarcascade_frontalface_default.xml"
    detector = cv2.CascadeClassifier(harcascadePath)
    (faces, Id) = getImagesAndLabels("C:/Users/user/PycharmProjects/E-Yantra/TrainingImage/")
    recognizer.train(faces, np.array(Id))
    recognizer.save("C:/Users/user/PycharmProjects/E-Yantra/Trainner.yml")
...
def getImagesAndLabels(path):
    resize = (200,200)
    recognizer = cv2.face.EigenFaceRecognizer_create()
    detector = cv2.CascadeClassifier("C:/Users/user/PycharmProjects/E-Yantra/haarcascade_frontalface_default.xml")
    height_d, width_d = 480, 640
    ...
    for imagePath in imagePaths:
        ...
        # extract the face from the training image sample
            faces.append(cv2.resize(imageNp[y:y+h,x:x+w], (height_d, width_d )))
            Ids.append(Id)
    return faces, Ids


def TrackImages():
    recognizer = cv2.face_LBPHFaceRecognizer_create()  # cv2.createLBPHFaceRecognizer()
