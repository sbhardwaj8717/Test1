...
def TakeImages():
    ...
    if (is_number(Id) and name.isalpha()):
        ...
        harcascadePath = "C:/Users/91935/PycharmProjects/untitled/haarcascade_frontalface_default.xml"
        ...
        while (True):
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.imwrite("C:/Users/91935/PycharmProjects/untitled/TrainingImage/ " + name + "." + Id + '.' + str(sampleNum) + ".jpg", gray[y:y + h, x:x + w])
                # display the frame
        ...
        row = [Id, name]
        with open('C:/Users/91935/PycharmProjects/untitled/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
...
def TrainImages():
    #pathhs='C:/Users/91935/PycharmProjects/untitled/TrainingImage'
    recognizer = cv2.face.LBPHFaceRecognizer_create()
    #recognizer = cv2.face.EigenFaceRecognizer_create()
    #harcascadePath = "C:/Users/91935/PycharmProjects/untitled/haarcascade_frontalface_default.xml"
    #detector = cv2.CascadeClassifier(harcascadePath)
    faces, Ids = getImagesAndLabels("C:/Users/91935/PycharmProjects/untitled/TrainingImage")
    print(Ids)
    recognizer.train(faces, np.array(Ids))
    recognizer.write('C:/Users/91935/PycharmProjects/untitled/Trainner.yml')
    res = "Image Trained"
    message.configure(text=res)
    print(dir(cv2.face))
    cv2.destroyAllWindows()
...
def getImagesAndLabels(path):
    ...
    for imagePath in imagePaths:
        ...
        # extract the face from the training image sample
            imageNp = cv2.resize(imageNp[y:y+h,x:x+w], (width_d, height_d))
            Faces = cv2.hconcat(imageNp[y:y+h,x:x+w])
        #for i in range(Id):
            Ids.append(Id)
    return Faces, Ids
...
def TrackImages():
    ...
    recognizer.read("C:/Users/91935/PycharmProjects/untitled/Trainner.yml")
    harcascadePath = "C:/Users/91935/PycharmProjects/untitled/haarcascade_frontalface_default.xml"
    faceCascade = cv2.CascadeClassifier(harcascadePath)
    df = pd.read_csv("C:/Users/91935/PycharmProjects/untitled/StudentDetails/StudentDetails.csv")
    cam = cv2.VideoCapture(0)
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            if (conf < 50):
                ...
                tt = str(Id)
            if (conf > 75):
                noOfFile = len(os.listdir("C:/Users/91935/PycharmProjects/untitled/ImagesUnknown")) + 1
                cv2.imwrite("C:/Users/91935/PycharmProjects/untitled/ImagesUnknown/Image" + str(noOfFile) + ".jpg", im[y:y + h, x:x + w])
    ...
    fileName = "C:/Users/91935/PycharmProjects/untitled/Attendance/Attendance_" + date + "_" + Hour + "-" + Minute + "-" + Second + ".csv"
...
trainImg = tk.Button(window, text="Train Images", command=TrainImages, fg="white", bg="red", width=20, height=3,
                     activebackground="Red", font=('times', 15, ' bold '))
